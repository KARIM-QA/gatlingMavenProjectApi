...
class PutApiRequestWithBearerAuthorization_Single_User_WithExternal_JsonFile extends Simulation {
  ...
  //Scenario
  val putUserScenario = scenario("Update User")
    .exec(
      http("User Put Request")
        .put("/users/5708715")
  ...
  setUp(
    putUserScenario.inject(atOnceUsers(1))
